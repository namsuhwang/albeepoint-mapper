...
public class TContMstHist implements Serializable {
    private Long contNo;

    private Long contHistSeq;

    private LocalDateTime contHistDt;
    ...
    public Long getContHistSeq() {
        return contHistSeq;
    }

    public void setContHistSeq(Long contHistSeq) {
        this.contHistSeq = contHistSeq;
    }

    public LocalDateTime getContHistDt() {
        return contHistDt;
    }

    public void setContHistDt(LocalDateTime contHistDt) {
        this.contHistDt = contHistDt;
    }
    ...
    public String toString() {
        ...
        sb.append(", contHistSeq=").append(contHistSeq);
        sb.append(", contHistDt=").append(contHistDt);
