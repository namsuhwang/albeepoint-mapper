...
public class TSubContMstHist implements Serializable {
    private Long contNo;
    ...
    private LocalDateTime subContHistDt;
    ...
    private LocalDateTime isuCancelStartDt;

    private LocalDateTime isuCancelEndDt;
    ...
    public Long getSubContHistSeq() {
        return subContHistSeq;
    }

    public void setSubContHistSeq(Long subContHistSeq) {
        this.subContHistSeq = subContHistSeq;
    }

    public LocalDateTime getSubContHistDt() {
        return subContHistDt;
    }

    public void setSubContHistDt(LocalDateTime subContHistDt) {
        this.subContHistDt = subContHistDt;
    }
    ...
    public LocalDateTime getIsuCancelStartDt() {
        return isuCancelStartDt;
    }

    public void setIsuCancelStartDt(LocalDateTime isuCancelStartDt) {
        this.isuCancelStartDt = isuCancelStartDt;
    }

    public LocalDateTime getIsuCancelEndDt() {
        return isuCancelEndDt;
    }

    public void setIsuCancelEndDt(LocalDateTime isuCancelEndDt) {
        this.isuCancelEndDt = isuCancelEndDt;
    }
    ...
    public String toString() {
        ...
        sb.append(", subContHistSeq=").append(subContHistSeq);
        sb.append(", subContHistDt=").append(subContHistDt);
        ...
        sb.append(", isuCancelStartDt=").append(isuCancelStartDt);
        sb.append(", isuCancelEndDt=").append(isuCancelEndDt);
