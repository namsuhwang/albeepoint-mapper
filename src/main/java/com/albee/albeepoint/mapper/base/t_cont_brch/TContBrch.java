...
public class TContBrch implements Serializable {
    private Long contNo;
    ...
    public String getContBrchStsCd() {
        return contBrchStsCd;
    }

    public void setContBrchStsCd(String contBrchStsCd) {
        this.contBrchStsCd = contBrchStsCd == null ? null : contBrchStsCd.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", contBrchStsCd=").append(contBrchStsCd);
